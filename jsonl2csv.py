...
input_file = "page_line_mentions_grouped_requests_log.txt"
output_file = "page_line_mentions_grouped_requests_output.csv"
...
with open(output_file, "w", newline="", encoding="utf-8") as f:
    writer = csv.DictWriter(f, fieldnames=[
        "発言ID", "発言者", "発言原文", "内容", "要求あり", "他の委員の発言参照", "参照されたページ・行", "理由"
    ])
    writer.writeheader()
